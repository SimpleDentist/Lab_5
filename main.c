...
int main(int argc, char* argv[])
{
    ...
    if (strcmp(argv[1], "--input") != 1)
    {
        printf("incorrect first arg");
        return 0;
    }

    if (strcmp(argv[3], "--output") != 1)
    {
    ...
    for (int step = 0; step < max_steps; step++)
    {
        ...
        if ((step + 1) % save_steps == 0)
        {
            ...
            data_bytes[40] = 0b00110000;
            data_bytes[41] = 0b10110001;
            data_bytes[42] = 0;
            data_bytes[43] = 0;
            data_bytes[44] = 0b00110000;
            data_bytes[45] = 0b10110001;
            for (int i = 46; i < 50; i++)
            {
                data_bytes[i] = 0;
            }
